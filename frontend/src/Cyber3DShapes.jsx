...
const GOLD = '#FFD700';
const CYAN = '#00F5D4';
const SHADOW = '0 8px 32px 0 rgba(255, 215, 0, 0.25)';
...
export default function Cyber3DShapes({ zIndex = 1 }) {
  return (
    <>
      ...
      <motion.div
        style={{
          position: 'absolute', top: '12%', right: '7%', zIndex,
      ...
      >
        <svg width="70" height="80" viewBox="0 0 70 80" fill="none">
          <defs>
            <linearGradient id="goldShield" x1="0" y1="0" x2="70" y2="80" gradientUnits="userSpaceOnUse">
              <stop stopColor="#FFD700" />
              <stop offset="1" stopColor="#FFF8DC" />
            </linearGradient>
          </defs>
          <path d="M35 5 Q65 15 60 40 Q55 70 35 75 Q15 70 10 40 Q5 15 35 5Z" fill="url(#goldShield)" stroke="#FFD700" strokeWidth="3" />
      ...
      <motion.div
        style={{
          position: 'absolute', bottom: '10%', left: '8%', zIndex,
      ...
      <motion.div
        style={{
          position: 'absolute', bottom: '18%', right: '12%', zIndex,
