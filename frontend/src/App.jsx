...
function ResponsiveNav({ onNavigate }) {
  return (
    <div style={{
      display: 'flex', justifyContent: 'center', gap: 18, marginTop: 24, flexWrap: 'wrap', zIndex: 10
    }}>
      <button
  ...
  return (
    <div style={{ minHeight: '100vh', width: '100vw', background: '#0a192f', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 420, margin: '0 auto', padding: '32px 12px', position: 'relative', zIndex: 2 }}>
        ...
        <ResponsiveNav onNavigate={handleNavigate} />
        {page === 'login' && (
